          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            {testimonials.slice(currentIndex, currentIndex + 2).concat(
              ...
              >
                ...
                <p className="text-foreground text-lg mb-6 leading-relaxed" data-testid={`text-testimonial-${testimonial.id}`}>
                  "{testimonial.text}"
                </p>
                ...
                <div>
                  <h4 className="font-bold text-foreground" data-testid={`text-client-name-${testimonial.id}`}>
                    {testimonial.name}
                  </h4>
                  <p className="text-muted-foreground text-sm" data-testid={`text-client-company-${testimonial.id}`}>
                    {testimonial.company}
                  </p>
                </div>
              </Card>
